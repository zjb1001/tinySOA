...
#   .../pysomeip/tinySOA/examples/system_tests/_common.py
_HERE = Path(__file__).resolve().parent          # system_tests/
_TINYSOA_SRC = _HERE.parents[1] / "src"          # tinySOA/src
_REPO_SRC = _HERE.parents[2] / "src"             # pysomeip/src
...
def setup_path() -> None:
    ...
    """
    for p in (str(_TINYSOA_SRC), str(_REPO_SRC)):
